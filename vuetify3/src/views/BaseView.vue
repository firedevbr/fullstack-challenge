<template>
  <v-app>
    ...
    >
      ...
      <!-- Aqui, você pode adicionar mais ícones ou ações específicas para a versão mobile se necessário. -->
    </v-app-bar>
  ...
  computed: {
    ...
    menuItems() {
      let menuItens = [
          ...
          //   id: 1,
          //   name: 'Projetos',
          //   isActive: this.$route.path === '/admin/listagem-projetos',
          //   linksTo: '/admin/listagem-projetos'
          // },
          // {
          //   id: 2,
          //   name: 'Entidades',
          //   isActive: this.$route.path === '/admin/listagem-entidades',
          //   linksTo: '/admin/listagem-entidades'
          // }
        ];
      // if (AuthService.usuarioPossuiPermissao('administracao')) {
      //   menuItens.push(
      //     {
      //       id: 3,
      //       name: 'Usuários',
      //       isActive: this.$route.path === '/admin/usuarios',
      //       linksTo: '/usuarios'
      //     },
      //     {
      //       id: 4,
      //       name: 'Diretrizes',
      //       isActive: this.$route.path === '/admin/diretrizes',
      //       linksTo: '/admin/diretrizes'
      //     },
      //     {
      //       id: 5,
      //       name: 'Agências',
      //       isActive: this.$route.path === '/admin/agencias',
      //       linksTo: '/admin/agencias'
      //     },
      //     {
      //       id: 6,
      //       name: 'Relatórios',
      //       isActive: this.$route.path === '/admin/relatorios',
      //       linksTo: '/admin/relatorios'
      //     }
      //   );
      // }
      return menuItens;
